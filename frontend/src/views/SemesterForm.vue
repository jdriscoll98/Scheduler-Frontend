          ...
          <div class="content">
            ...
            <div class="form-group">
              ...
              <select class="form-input">
                ...
                <option label="African American Studies" value="16620000">African American Studies</option>
                ...
                <option
                  ...
                  value="19140000"
                >Computer &amp; Information Science &amp; Engineering</option>
                <option
                ...
                <option label="Dentistry-Prosthodontics" value="34140000">Dentistry-Prosthodontics</option>
                <option
                  label="Design, Construction &amp; Planning-General"
                  value="15010000"
                >Design, Construction &amp; Planning-General</option>
                <option label="Digital Worlds Institute" value="13050000">Digital Worlds Institute</option>
                ...
                <option label="Entomology and Nematology" value="60140000">Entomology and Nematology</option>
                <option
                ...
                <option label="Interdisciplinary Studies" value="16000000">Interdisciplinary Studies</option>
                ...
                <option label="Pharmacy-Pharmacodynamics" value="32040000">Pharmacy-Pharmacodynamics</option>
                <option
