          ...
          <div class="content">
            <form @submit.prevent="fetchCourses">
              ...
              <div class="form-group">
                ...
                >
                  <option value class selected="selected">--</option>
                  <option label="Accounting, Fisher School of" value="17030000"
                  ...
                  <option label="Civil and Coastal Engineering" value="19040000"
                  ...
                  >
                  <option label="Health Education and Behavior" value="26050000"
                  ...
                  >
                  <option label="Large Animal Clinical Science" value="28040000"
                  ...
                  >
                  <option label="Medicine-Neurological Surgery" value="29190000"
                  ...
                  >
                  <option label="Microbiology and Cell Science" value="60100000"
                  ...
                  <option label="Pathobiology" value="28100000"
                    >Pathobiology</option
                  >
                  <option label="Pharmacy-Medicinal Chemistry" value="32030000"
